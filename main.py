...
def get_saju(year: int, month: int, day: int, time: str = "00:00", is_lunar: bool = False):
    ...
    prompt = f"""
    당신은 30년 경력의 친절하고 지혜로운 명리학(사주) 전문가입니다.
    다음 사주팔자를 바탕으로 이 사람의 전반적인 성향, 재물운, 직업운, 결혼운, 가정운을 각각 3~4문단으로 알기 쉽게 풀이해주세요.
    그리고 추가적으로 2026년도, 2027년도에 어떤 사건이 발생하는지도 상세히 알려주세요.
